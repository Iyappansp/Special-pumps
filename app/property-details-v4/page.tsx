								...
								<div className="col-lg-12">
									<div className="images-area-details">
										<Slider {...settings1} className="img3-carousel">
											<img src="/assets/img/all-images/properties/property-img29.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img39.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img40.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img41.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img42.png" alt="Special Pumps" />
										</Slider>
										<div className="space30" />
										<Slider {...settings2} className="img4">
											<img src="/assets/img/all-images/properties/property-img1.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img43.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img44.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img45.png" alt="Special Pumps" />
											<img src="/assets/img/all-images/properties/property-img46.png" alt="Special Pumps" />
										</Slider>
									</div>
											...
											<div className="details-siderbar">
												<div className="content-area">
													...
													<div className="list-area">
														<div className="list">
															<ul>
																<li>Features:</li>
																<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="Special Pumps" />x20 <span> | </span></Link></li>
																<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="Special Pumps" />x30 <span> | </span></Link></li>
																<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="Special Pumps" />1200 sq</Link></li>
															</ul>
															<div className="space24" />
															<ul>
																<li>Location:</li>
												...
												<Swiper {...swiperOptions} className="property-details-slider owl-carousel">
													<SwiperSlide className="img1">
														<img src="/assets/img/all-images/properties/property-img30.png" alt="Special Pumps" />
													</SwiperSlide>
													<SwiperSlide className="img1">
														<img src="/assets/img/all-images/properties/property-img31.png" alt="Special Pumps" />
													</SwiperSlide>
													<SwiperSlide className="img1">
														<img src="/assets/img/all-images/properties/property-img32.png" alt="Special Pumps" />
													</SwiperSlide>
													<SwiperSlide className="img1">
														<img src="/assets/img/all-images/properties/property-img30.png" alt="Special Pumps" />
													</SwiperSlide>
												...
												<div className="bg1">
													...
													<div className="vide-images">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img33.png" alt="Special Pumps" />
														</div>
														<VideoPopup />
													</div>
												</div>
												...
												<div className="bg1">
													...
													<div className="rotate-images">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img34.png" alt="Special Pumps" />
														</div>
														<Link href="/#"><img src="/assets/img/icons/rotate.svg" alt="Special Pumps" /></Link>
													</div>
												</div>
												<div className="space60" />
												<h3>Floor Plans</h3>
														...
														<div className="accordion-item">
															<h2 className="accordion-header">
																<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
																	...
																	<span className="list">
																		<span><img src="/assets/img/icons/bed1.svg" alt="Special Pumps" />x20</span>
																		<span><img src="/assets/img/icons/bath1.svg" alt="Special Pumps" />x30</span>
																		<span><img src="/assets/img/icons/sqare1.svg" alt="Special Pumps" />1200 sq</span>
																	</span>
																</button>
															</h2>
															<div id="flush-collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
																<div className="accordion-body">
																	<div className="img1">
																		<img src="/assets/img/all-images/others/map-img1.png" alt="Special Pumps" />
																	</div>
																</div>
															</div>
														</div>
									...
									<Swiper {...swiperOptions2} className="single-slider-area owl-carousel">
										<SwiperSlide className="property-boxarea">
											<div className="img1 image-anime">
												<img src="/assets/img/all-images/properties/property-img2.png" alt="Special Pumps" />
											</div>
											...
											<div className="content-area">
												...
												<div className="space24" />
												<ul>
													<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="Special Pumps" />x12</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="Special Pumps" />x16</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="Special Pumps" />1200 sq</Link></li>
												</ul>
												<div className="btn-area">
													<Link href="/#" className="nm-btn">$820,000</Link>
													<Link href="#" className="heart"><img src="/assets/img/icons/heart1.svg" alt="Special Pumps" className="heart1" /> <img src="/assets/img/icons/heart2.svg" alt="Special Pumps" className="heart2" /></Link>
												</div>
											</div>
										</SwiperSlide>
										<SwiperSlide className="property-boxarea">
											...
											<div className="content-area">
												...
												<div className="space24" />
												<ul>
													<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="Special Pumps" />x20</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="Special Pumps" />x30</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="Special Pumps" />1200 sq</Link></li>
												</ul>
												<div className="btn-area">
													<Link href="/#" className="nm-btn">$820,000</Link>
										...
										<SwiperSlide className="property-boxarea">
											<div className="img1 image-anime">
												<img src="/assets/img/all-images/properties/property-img6.png" alt="Special Pumps" />
											</div>
											<div className="category-list">
												<ul>
													<li><Link href="/property-details-v1">Featured</Link></li>
											...
											<div className="content-area">
												...
												<div className="space24" />
												<ul>
													<li><Link href="/#"><img src="/assets/img/icons/bed1.svg" alt="Special Pumps" />x23</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/bath1.svg" alt="Special Pumps" />x34</Link></li>
													<li><Link href="/#"><img src="/assets/img/icons/sqare1.svg" alt="Special Pumps" />1200 sq</Link></li>
												</ul>
												<div className="btn-area">
													<Link href="/#" className="nm-btn">$820,000</Link>
