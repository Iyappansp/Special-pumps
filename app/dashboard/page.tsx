												...
												<div className="table-row">
													<div className="listing">
														...
														<div className="details">
															...
															<p>
																<span><img src="/assets/img/icons/bed1.svg" alt="Special Pumps" /> x2</span>
																<span><img src="/assets/img/icons/bath1.svg" alt="Special Pumps" /> x2</span>
																<span><img src="/assets/img/icons/sqare1.svg" alt="Special Pumps" /> 1200
																	sq</span>
															</p>
									...
									<div className="dashboard-info-sider-deatils">
										...
										<div className="dashboard-info-sider">
											...
											<div className="message-boxarea" style={{ borderBottom: 'none', padding: 0 }}>
												<div className="space32" />
												<div className="img1">
													<img src="/assets/img/all-images/others/dash-img10.png" alt="Special Pumps" />
												</div>
												<div className="conatent-area">
													<div className="content">
