									...
									<div className="row">
										<div className="col-lg-12">
											<div className="blog-post-details-area heading1">
												<div className="img1">
													<img src="/assets/img/all-images/blog/blog-img20.png" alt="Special Pumps" />
												</div>
												...
												<div className="row">
													<div className="col-lg-6 col-md-6">
														<div className="space30" />
														<div className="img1">
															<img src="/assets/img/all-images/blog/blog-img16.png" alt="Special Pumps" />
														</div>
													</div>
													<div className="col-lg-6 col-md-6">
														<div className="space30" />
														<div className="img1">
															<img src="/assets/img/all-images/blog/blog-img14.png" alt="Special Pumps" />
														</div>
													</div>
												</div>
												...
												<div className="row">
													...
													<div className="col-lg-4 col-md-6">
														<div className="list-area">
															<ul>
																<li><img src="/assets/img/icons/check1.svg" alt="Special Pumps" /> Access To Amenities</li>
																<li><img src="/assets/img/icons/check1.svg" alt="Special Pumps" /> Healthcare Services</li>
															</ul>
														</div>
													</div>
													<div className="col-lg-4 col-md-6">
														<div className="list-area">
															<ul>
																<li><img src="/assets/img/icons/check1.svg" alt="Special Pumps" /> Transportation A Commute</li>
																<li><img src="/assets/img/icons/check1.svg" alt="Special Pumps" /> Child-Friendly Environment</li>
															</ul>
														</div>
													</div>
													<div className="col-lg-4 col-md-6">
														<div className="list-area">
															<ul>
																<li><img src="/assets/img/icons/check1.svg" alt="Special Pumps" /> A Pet-Friendly Areas</li>
																<li><img src="/assets/img/icons/check1.svg" alt="Special Pumps" /> Climate and Weather</li>
															</ul>
														</div>
													</div>
												</div>
												...
												<div className="vide-images">
													<div className="img1">
														<img src="/assets/img/all-images/blog/blog-img21.png" alt="Special Pumps" />
													</div>
													<VideoPopup />
												</div>
												<div className="space28" />
						...
						<div className="container">
							...
							<div className="row">
								<div className="col-lg-4 col-md-6">
									<div className="blog-single-boxarea">
										<div className="img1 image-anime">
											<img src="/assets/img/all-images/blog/blog-img12.png" alt="Special Pumps" />
										</div>
								...
								<div className="col-lg-4 col-md-6">
									<div className="blog-single-boxarea">
										<div className="img1 image-anime">
											<img src="/assets/img/all-images/blog/blog-img13.png" alt="Special Pumps" />
										</div>
										<div className="content-area">
											<ul>
												<li><Link href="/#"><svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
