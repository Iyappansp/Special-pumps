											...
											<div className="all-side-details">
												<div className="details-siderbar2">
													...
													<aside className="quoteCard">
														<div className="input-area field">
														...
														<div className="btnRow">
															<button type="submit" className="btnPrimary theme-btn1">Find Properties <span className="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} fill="currentColor">
