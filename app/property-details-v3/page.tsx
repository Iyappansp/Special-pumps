										...
										<div className="row">
											<div className="col-lg-6">
												<Swiper {...swiperOptions2} className="img2-carousel owl-carousel mb-4">
													<SwiperSlide>
														<img src="/assets/img/all-images/properties/property-img35.png" alt="Special Pumps" />
													</SwiperSlide>
													<SwiperSlide>
														<img src="/assets/img/all-images/properties/property-img35.png" alt="Special Pumps" />
													</SwiperSlide>
												...
												<div className="row">
													<div className="col-lg-6 col-md-6">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img36.png" alt="Special Pumps" />
														</div>
													</div>
													<div className="col-lg-6 col-md-6">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img37.png" alt="Special Pumps" />
															<VideoPopup />
														</div>
													</div>
												</div>
											...
											<div className="col-lg-6">
												...
												<div className="images-area2">
													<div className="img1">
														<img src="/assets/img/all-images/properties/property-img38.png" alt="Special Pumps" />
													</div>
											...
											<div className="details-siderbar">
												...
												<div className="download-box">
													...
													<div className="download">
														<Link href="/#"><span><img src="/assets/img/icons/pdf1.svg" alt="Special Pumps" /></span>Villa Document. pdf <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
															<path d="M13 10H18L12 16L6 10H11V3H13V10ZM4 19H20V12H22V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V12H4V19Z" />
														</svg></Link>
														<Link href="/#" className="m-0"><span><img src="/assets/img/icons/pdf2.svg" alt="Special Pumps" /></span>Villa Document. pdf <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
															<path d="M13 10H18L12 16L6 10H11V3H13V10ZM4 19H20V12H22V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V12H4V19Z" />
														</svg></Link>
													</div>
												</div>
												...
												<div className="comments-boxarea box2">
													<div className="comments-boxes">
														<div className="comments-auhtor-box">
															<div className="img3">
																<img src="/assets/img/all-images/blog/blog-img18.png" alt="Special Pumps" />
															</div>
															<div className="content">
																<Link href="/#" className="date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
																	<path d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM8 13V15H6V13H8ZM13 13V15H11V13H13ZM18 13V15H16V13H18ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z" />
