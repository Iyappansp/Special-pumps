											...
											<div className="col-lg-4">
												...
												<div className="property-latest">
													...
													<div className="latest-proprty">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img25.png" alt="Special Pumps" />
														</div>
													...
													<div className="latest-proprty">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img26.png" alt="Special Pumps" />
														</div>
														<div className="content">
													...
													<div className="latest-proprty">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img27.png" alt="Special Pumps" />
														</div>
														<div className="content">
													...
													<div className="latest-proprty">
														<div className="img1">
															<img src="/assets/img/all-images/properties/property-img28.png" alt="Special Pumps" />
														</div>
														<div className="content">
