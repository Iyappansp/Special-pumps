										...
										<ul>
											...
											<li><Link href="/#" className="plus">Properties <i className="fa-solid fa-angle-down" /></Link>
												<ul className="dropdown-padding">
													<li><Link href="/property-details-v1">Properties 1</Link></li>
													<li><Link href="/property-details-v2">Properties 2</Link></li>
													<li><Link href="/property-details-v3">Properties 3</Link></li>
													<li><Link href="/property-details-v4">Properties 4</Link></li>
												</ul>
											</li>
