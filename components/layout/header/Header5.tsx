							...
							<div className="col-lg-12">
								<div className="header-top-area">
									<ul className="header-content">
										...
										</svg> Special Pumps@gmail.com</Link> <span> | </span></li>
									...
									<ul className="list-content">
										<li><img src="/assets/img/elements/elements11.png" alt="Special Pumps" /><select name="country" id="country" className="country-area nice-select">
															...
															<div className="all-images-menu">
																<div className="images">
																	<div className="homemenu-thumb">
																		<div className="img1">
																			<img src="/assets/img/all-images/demo/demo-img1.png" alt="Special Pumps" />
																		</div>
																		...
																		<div className="homemenu-content">
																			<Link href="/">Special Pumps - Homepage 01</Link>
																		</div>
																	</div>
																</div>
																<div className="images">
																	<div className="homemenu-thumb">
																		<div className="img1">
																			<img src="/assets/img/all-images/demo/demo-img2.png" alt="Special Pumps" />
																		</div>
																		<div className="homemenu-btn">
																		...
																		<div className="homemenu-content">
																			<Link href="/index2">Special Pumps - Homepage 02</Link>
																		</div>
																	</div>
																</div>
																<div className="images">
																	<div className="homemenu-thumb">
																		<div className="img1">
																			<img src="/assets/img/all-images/demo/demo-img3.png" alt="Special Pumps" />
																		</div>
																		<div className="homemenu-btn">
																		...
																		<div className="homemenu-content">
																			<Link href="/index3">Special Pumps - Homepage 03</Link>
																		</div>
																	</div>
																</div>
																<div className="images">
																	<div className="homemenu-thumb">
																		<div className="img1">
																			<img src="/assets/img/all-images/demo/demo-img4.png" alt="Special Pumps" />
																		</div>
																		<div className="homemenu-btn">
																		...
																		<div className="homemenu-content">
																			<Link href="/index4">Special Pumps - Homepage 04</Link>
																		</div>
																	</div>
																</div>
															</div>
