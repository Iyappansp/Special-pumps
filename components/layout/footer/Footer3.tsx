		...
		<>
			<div>
				<div className="footer-top-section">
					<img src="/assets/img/elements/elements5.png" alt="Special Pumps" className="elements5" />
					<div className="container">
						<div className="row">
							<div className="col-lg-12">
								<div className="footer-top-area">
									<div className="img1">
										<Link href="/"><img src="/assets/img/logo/logo4.png" alt="Special Pumps" /></Link>
									</div>
									<div className="pera">
						...
						<div className="row">
							<div className="col-lg-12">
								<div className="copyright">
									<p>©Copyright {new Date().getFullYear()} - Special Pumps. All Right Reserved</p>
									<ul>
