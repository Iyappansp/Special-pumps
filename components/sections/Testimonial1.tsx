...
const testimonialSlides = [
	{
		quote: "When I decided to sell my home, I was overwhelmed with where to start. Special Pumps stepped in with a clear plan, professional marketing, constant communicate. Within two weeks, my house was sold above asking.",
												...
												<div key={index} className="testimonial-box">
													...
													<div className="test-images">
														<div className="auhtor-area">
															<div className="img1">
																<img src={slide.authorImg} alt="Special Pumps" />
															</div>
															<div className="text">
