			...
			<div className="hero3-section-area" style={{ backgroundImage: 'url(assets/img/all-images/bg/hero-bg3.png)', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
				...
				<div className="main-imagesarea">
					<div className="img1 aniamtion-key-2">
						<img src="/assets/img/all-images/hero/hero3-img1.png" alt="Special Pumps" />
					</div>
					<div className="img2">
						<img src="/assets/img/elements/bottom-img2.png" alt="Special Pumps" />
					</div>
				</div>
				<div className="img3">
					<img src="/assets/img/elements/bottom-img1.png" alt="Special Pumps" />
				</div>
				{/*===== OTHERS AREA STARTS =======*/}
				...
				<div className="villa-listing">
					...
					<div className="villa-images">
						<div className="img1">
							<img src="/assets/img/all-images/others/others-img4.png" alt="Special Pumps" />
						</div>
						<div className="text">
				...
				<div className="villa-listing2">
					...
					<div className="villa-images">
						<div className="img1">
							<img src="/assets/img/all-images/others/others-img5.png" alt="Special Pumps" />
						</div>
						<div className="text">
