										...
										<div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabIndex={0}>
											<div className="row">
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														...
														<div className="content-area">
															...
															<ul>
																<li><Link href="/#"><span className="icon"><img src="/assets/img/icons/bed1.svg" alt="Special Pumps" /></span> 12 <span className="line"> |
																</span></Link></li>
																<li><Link href="/#"><span className="icon"><img src="/assets/img/icons/bath1.svg" alt="Special Pumps" /></span> 08 <span className="line"> |
																</span></Link></li>
												...
												<div className="col-lg-4 col-md-6">
													<div className="property-single-boxarea">
														<div className="img1 image-anime">
															<img src="/assets/img/all-images/properties/property-img16.png" alt="Special Pumps" />
														</div>
														<ul className="category-list">
															<li><Link href="/property-details-v1">Featured</Link></li>
															<li><Link href="/property-details-v1">For Rent</Link></li>
