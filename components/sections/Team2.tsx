					...
					<div className="row">
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={800}>
							<div className="team-single-boxarea">
								<div className="img1">
									<img src="/assets/img/all-images/team/team-img5.png" alt="Special Pumps" />
								</div>
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={900}>
							<div className="team-single-boxarea">
								<div className="img1">
									<img src="/assets/img/all-images/team/team-img6.png" alt="Special Pumps" />
								</div>
								<div className="content-area">
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1000}>
							<div className="team-single-boxarea">
								<div className="img1">
									<img src="/assets/img/all-images/team/team-img7.png" alt="Special Pumps" />
								</div>
								<div className="content-area">
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1200}>
							<div className="team-single-boxarea">
								<div className="img1">
									<img src="/assets/img/all-images/team/team-img8.png" alt="Special Pumps" />
								</div>
								<div className="content-area">
