					...
					<div className="row">
						<div className="col-lg-6 m-auto">
							<div className="team-header text-center heading3 space-margin60">
								...
								<h2 className="text-anime-style-3">Experts Behind Special Pumps</h2>
							</div>
						</div>
					</div>
					<div className="row">
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={800}>
							<div className="team3-boxarea">
								<div className="img1 image-anime">
									<img src="/assets/img/all-images/team/team-img9.png" alt="Special Pumps" />
								</div>
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={900}>
							<div className="team3-boxarea">
								<div className="img1 image-anime">
									<img src="/assets/img/all-images/team/team-img10.png" alt="Special Pumps" />
								</div>
								<div className="content-area">
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1000}>
							<div className="team3-boxarea">
								<div className="img1 image-anime">
									<img src="/assets/img/all-images/team/team-img11.png" alt="Special Pumps" />
								</div>
								<div className="content-area">
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1200}>
							<div className="team3-boxarea">
								<div className="img1 image-anime">
									<img src="/assets/img/all-images/team/team-img12.png" alt="Special Pumps" />
								</div>
								<div className="content-area">
