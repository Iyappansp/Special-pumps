					...
					<div className="row">
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={800}>
							<div className="work-single-boxarea">
								<div className="img1">
									<img src="/assets/img/all-images/work/work-img1.png" alt="Special Pumps" />
								</div>
								<div className="space20" />
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={900}>
							<div className="work-single-boxarea">
								<div className="img1">
									<img src="/assets/img/all-images/work/work-img2.png" alt="Special Pumps" />
								</div>
								<div className="space20" />
								<div className="content">
									<h3>2</h3>
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1000}>
							<div className="work-single-boxarea">
								<div className="img1">
									<img src="/assets/img/all-images/work/work-img3.png" alt="Special Pumps" />
								</div>
								<div className="space20" />
								<div className="content">
									<h3>3</h3>
						...
						<div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1200}>
							<div className="work-single-boxarea box2">
								<div className="img1">
									<img src="/assets/img/all-images/work/work-img4.png" alt="Special Pumps" />
								</div>
								<div className="space20" />
								<div className="content">
									<h3>4</h3>
