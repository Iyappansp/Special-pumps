										...
										<div className="accordion" id="accordionExample3">
											<div className="accordion-item">
												<h2 className="accordion-header">
                                                    ...
                                                    How do I get the right pump?</button>
												</h2>
												<div id="collapse11" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
													<div className="accordion-body">
														<p>Share duty conditions (fluid, flow, head, temperature, NPSH) and receive a matched recommendation.</p>
													</div>
												</div>
											</div>
											<div className="accordion-item">
												<h2 className="accordion-header">
                                                    ...
                                                    Do you install and commission?

</button>
												</h2>
												<div id="collapse12" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
													<div className="accordion-body">
														<p>Yes—complete installation and start‑up with on‑site checks and handover.</p>
													</div>
												</div>
											</div>
											<div className="accordion-item">
												<h2 className="accordion-header">
                                                    ...
                                                    Can you service non‑clog and dewatering pumps?</button>
												</h2>
												<div id="collapse13" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
													<div className="accordion-body">
														<p>Yes—we handle sludge, sewage, and site dewatering units, including wear parts and seals.</p>
													</div>
												</div>
											</div>
											<div className="accordion-item">
												<h2 className="accordion-header">
                                                    ...
                                                    Do you support hot oil applications?

</button>
												</h2>
												<div id="collapse14" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
													<div className="accordion-body">
														<p>Yes—Thermic Fluid Hot Oil Pumps rated up to 320°C with appropriate sealing and bearings.</p>
													</div>
												</div>
											</div>
											<div className="accordion-item">
												...
												<div id="collapse15" className="accordion-collapse collapse" data-bs-parent="#accordionExample3">
													<div className="accordion-body">
														<p>Common spares maintained for quick replacement; parts are built for interchangeability.</p>
													</div>
												</div>
											</div>
										</div>
